...
const TestimonialsSection = () => {
  return (
    <div  className='pb-14 px-8 md:px-0'>
      ...
      <p className='md:text-base text-gray-500 mt-3'>Discover how learners from all walks of life have benefited. <br /> Real stories. Real results.</p>
          ...
          <div className='flex items-center gap-4 px-5 py-4 bg-gray-500/10'>
           ...
           <div className='p-5 pb-7'>
             <div className='flex gap-0.5'>{[...Array(5)].map((_,i)=>(
              <img key={i} src={i<Math.floor(testimonial.rating) ? assets.star : assets.star_blank } alt='star' className='h-5'></img>
             ))}</div>
